...
//			    		  dmi_max=abs(*(pi->get_mass_grad() + k));
...
#if CODE_DIMENSION==3
				  H_new = eta_smooth_P * (lbd1_P*cbrt(pi->get_mass()/(C_sml2_P*rho_star+C_sml1_P*pi->get_initial_des ()))+lbd_P*pi->get_original_smlen ());
#elif CODE_DIMENSION==2
				  H_new = eta_smooth_P * (lbd1_P*sqrt(pi->get_mass()/(C_sml2_P*rho_star+C_sml1_P*pi->get_initial_des ()))+lbd_P*pi->get_original_smlen ());
#elif CODE_DIMENSION==1
				  H_new = eta_smooth_P * (lbd1_P*(pi->get_mass()/(C_sml2_P*rho_star+C_sml1_P*pi->get_initial_des()))+lbd_P*pi->get_original_smlen ());
#endif //CODE_DIMENSION
