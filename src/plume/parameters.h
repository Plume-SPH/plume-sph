...
///*
// * Parameters for running umbrella simulation: Grimsvotn
// *
// */
//
////----------------------------------------------------------------------------------------
...
// newly added:
const double Cpv_P=Cps_P*ng0_P*msfc0_P* + msfc0_P*(1-ng0_P)*Cpg_P + (1-msfc0_P)*Cpa_P; /*specific heat of erupted material under constant pressure*/
